...
class _AdminVendorAssignmentScreenState
  ...
  Future<void> _approveVendor() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Shop owner approved successfully'),
          backgroundColor: AppColors.success,
          behavior: SnackBarBehavior.floating,
        ),
      );
  ...
  Future<void> _rejectVendor() async {
    ...
    try {
      ...
      await authNotifier.updateVendorShopAssignment(
        vendorId: widget.vendor.id,
        shopName: _shopNameCtrl.text.trim(),
        shopAddress: _shopNameCtrl.text.trim(),
        shopLatitude: double.parse(_latitudeCtrl.text.trim()),
        shopLongitude: double.parse(_longitudeCtrl.text.trim()),
        assignedRadiusKm: double.parse(_radiusCtrl.text.trim()),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Shop owner rejected'),
              ...
              child: Column(
                children: [
                  ...
                  children: [
                    ...
                    // Approval is handled via Approve/Reject buttons below.
                    ...
                    if (widget.vendor.vendorStatus == VendorStatus.pendingApproval) ...[
                      Row(
                        children: [
                          Expanded(
                            child: OutlinedButton(
                              onPressed: _isSaving ? null : _rejectVendor,
                              style: OutlinedButton.styleFrom(
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed: (_selectedCategories.isEmpty || _isSaving) ? null : _approveVendor,
