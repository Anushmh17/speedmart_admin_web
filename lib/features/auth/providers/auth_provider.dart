...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  Future<void> updateVendorShopAssignment({
    ...
    final updatedVendor = vendor.copyWith(
      ...
      // Set vendorStatus based on approval flag
      vendorStatus: vendorApproved ? VendorStatus.approved : VendorStatus.rejected,
      allowedCategories: allowedCategories,
      requestedCategories: requestedCategories ?? [],
      hasPendingCategoryRequest: hasPendingCategoryRequest ?? false,
      // Only mark shop location assigned when vendor is approved
      isShopLocationAssigned: vendorApproved,
    );
